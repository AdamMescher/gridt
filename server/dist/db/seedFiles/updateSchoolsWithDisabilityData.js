...
const updateSchoolsWithDisabilityData = async collection => {
  const basePath = "./seedData/2017-18-crdc-data-corrected-publication 2/2017-18 Public-Use Files/Data/SCH/EDFacts/CSV/ID 74 SCH - Race by Sex by Disability plus LEP";
  ...
  const files = [plusAut, plusDb, plusDd, plusEmn, plusHi, plusMd, plusMr, plusOhi, plusOi, plusSld, plusSli, plusTbi, plusVi];
