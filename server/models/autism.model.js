...
const autismSchema = new mongoose.Schema({
  ...
  RR_BL_MPOP_AUT: { type: Number, index: true },
  RI_WH_M_AUT_9: { type: Number },
  RR_BL_M_WH_M_AUT: { type: Number, index: true },
  SCH_AUT_ENR_BL_F: { type: Number },
