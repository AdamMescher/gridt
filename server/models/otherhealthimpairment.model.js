...
const otherhealthimpairmentSchema = new mongoose.Schema({
  ...
  SCH_OHI_ENR_HI_M: { type: Number, index: true },
  ...
  SCH_OHI_ENR_HI_F: { type: Number, index: true },
  ...
  SCH_OHI_ENR_AM_M: { type: Number, index: true },
  ...
  SCH_OHI_ENR_AM_F: { type: Number, index: true },
  ...
  SCH_OHI_ENR_AS_M: { type: Number, index: true },
  ...
  SCH_OHI_ENR_AS_F: { type: Number, index: true },
  ...
  SCH_OHI_ENR_HP_M: { type: Number, index: true },
  ...
  SCH_OHI_ENR_HP_F: { type: Number, index: true },
  ...
  SCH_OHI_ENR_BL_M: { type: Number, index: true },
  ...
  SCH_OHI_ENR_BL_F: { type: Number, index: true },
  ...
  SCH_OHI_ENR_TR_M: { type: Number, index: true },
  ...
  SCH_OHI_ENR_TR_F: { type: Number, index: true },
  ...
  SCH_OHI_ENR_WH_M: { type: Number, index: true },
  ...
  SCH_OHI_ENR_WH_F: { type: Number, index: true },
